...
/**
 * Use br line breaks for ChatGPT web pages
 *
 * fix: https://github.com/wenyuanw/quick-prompt/issues/42
 */
const RULES: Rule[] = [{ pattern: /chatgpt\.com/i, strategy: 'br' }];
...
export function setElementContentByStrategy(el: HTMLElement, text: string, strategy: NewlineStrategy): void {
  if (strategy === 'br') {
